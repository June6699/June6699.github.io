...
tags:
    - Windows
asset-dir:  Win11-Right-Click.assets
---
...
![Win11右键菜单正在加载中](./Win11-Right-Click.assets/Win11右键正在加载中.png)
...
- **本地文件下载**：[点击下载]({{ site.baseurl }}/assets/Win11-Right-Click.assets/Win11改用传统右键菜单.txt)（下载后请将文件后缀改为 `.bat`）
